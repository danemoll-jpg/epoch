...
|---|---|---|---|---|
| Settler | Old wagon | Delapouite | https://game-icons.net/1x1/delapouite/old-wagon.html | CC BY 3.0 |
| Warrior | Caveman | Delapouite | https://game-icons.net/1x1/delapouite/caveman.html | CC BY 3.0 |
| Archer | Bowman | Lorc | https://game-icons.net/1x1/lorc/bowman.html | CC BY 3.0 |
| Spearman | Spartan | Lorc | https://game-icons.net/1x1/lorc/spartan.html | CC BY 3.0 |
| Horseman | Horse head | Delapouite | https://game-icons.net/1x1/delapouite/horse-head.html | CC BY 3.0 |
| Chariot | Chariot | Cathelineau | https://game-icons.net/1x1/cathelineau/chariot.html | CC BY 3.0 |
| Legion | Centurion helmet | Delapouite | https://game-icons.net/1x1/delapouite/centurion-helmet.html | CC BY 3.0 |
| Catapult | Catapult | HeavenlyDog | https://game-icons.net/1x1/heavenly-dog/catapult.html | CC BY 3.0 |
| Pikeman | Pikeman | Delapouite | https://game-icons.net/1x1/delapouite/pikeman.html | CC BY 3.0 |
| Knight | Mounted knight | Skoll | https://game-icons.net/1x1/skoll/mounted-knight.html | CC BY 3.0 |
| Musketman | Blunderbuss | Lorc | https://game-icons.net/1x1/lorc/blunderbuss.html | CC BY 3.0 |
| Cannon | Cannon | Lorc | https://game-icons.net/1x1/lorc/cannon.html | CC BY 3.0 |
...
- **Sound effects** (the 14 in `src/assets/sounds/`): generated by Dan with
  [ElevenLabs](https://elevenlabs.io) Sound Effects, for this game.
- **Music** (the theme and the four era tracks, `music-*.mp3`): generated by Dan with
  [Suno](https://suno.com), for this game.

Check each service's terms for the plan the files were made on before any public release; for
a game shared with family and friends they're used as made.

## Leader portraits and the app icon

- **Leader portraits** (`src/assets/portraits/`): made for this game by Dan (`docs/PORTRAITS.md`).
- **App icon** (`public/icons/`, master in `docs/app-icon/`): made for this game by Dan
  (`docs/APP-ICON.md`).

## Fonts

None bundled: the game uses the device's own fonts (the title's serif is Iowan Old Style on the
iPad, Palatino or Georgia elsewhere).
